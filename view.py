...
class CountFrame(Frame):  # 继承Frame类
    ...
    def filterLog(self):
        print('过滤标签:{}'.format(self.filterTag.get()))
        #过滤标签
        ...
        print('正则过滤:{}'.format(self.filterRegular.get()))
        #日志级别
        logLevel=self.logLevel.get()
        print('日志级别:{}'.format(self.logLevel.get()))
        #过滤格式项
        filterFormat=self.filterFormat.get()
        print('过滤格式项:{}'.format(self.filterFormat.get()))
